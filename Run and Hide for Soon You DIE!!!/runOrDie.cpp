...
#include "runOrDieInputComponent.hpp"
...
int main(int argc, char** argv) {
    ...
    GameLib::Actor player(
        new runOrDieInputComponent(), new GameLib::SimpleActorComponent(), new CollisionPhysicsComponent(), new GameLib::SimpleGraphicsComponent());
    ...
    GameLib::Actor spiderActor(new SpiderInputComponent(), new SpiderActorComponent(), new CollisionPhysicsComponent(), new GameLib::SimpleGraphicsComponent());

    world.actors.push_back(&spiderActor);
